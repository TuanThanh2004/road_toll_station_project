...
"""
    class ExceptionType : Các loại ngoại lệ mà ứng dụng gặp phải
"""
class ExceptionType(enum.Enum):
    ...
    # đảm bảo gán giá trị tự động cho ExceptionType thành viên mới và bắt đầu từ 1
    ...
    # http_code: Mã trạng thái HTTP sẽ được sử dụng trong phản hồi (ví dụ: 500 đối với lỗi máy chủ nội bộ).
    # code: Mã lỗi dành riêng cho ứng dụng tùy chỉnh (ví dụ: '990' để bảo trì).
    # message: Một thông báo thân thiện với người dùng mô tả lỗi
...
"""
    đây là lớp cơ sở cho các ngoại lệ dành riêng cho ứng dụng
"""
